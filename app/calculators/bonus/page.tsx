...
export default function BonusCalculatorComingSoonPage() {
  return (
      ...
      <div className="max-w-lg w-full">
        ...
        <div className="rounded-xl shadow-lg overflow-hidden border border-orange-200 bg-white">
          ...
          <div className="p-8 sm:p-12 text-center">
            ...
            <p className="text-sm text-neutral-500 mb-8">
              We're building a comprehensive tool to calculate statutory bonuses with eligibility checks, pro-rata calculations, and attendance adjustments.
            </p>
            ...
            <div className="bg-orange-50 rounded-lg p-6 mb-8 text-left">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-neutral-700">Statutory eligibility threshold validation</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-orange-600 font-bold mt-0.5">✓</span>
                  <span className="text-neutral-700">Capped calculation base with minimum wage support</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-orange-600 font-bold mt-0.5">✓</span>
                  <span className="text-neutral-700">Pro-rata bonus calculation for partial months</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-orange-600 font-bold mt-0.5">✓</span>
                  <span className="text-neutral-700">Attendance and productivity scaling</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-orange-600 font-bold mt-0.5">✓</span>
                  <span className="text-neutral-700">Ex-gratia policy options</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="mt-8 text-center">
          <div className="inline-flex items-center gap-2 text-neutral-600">
            ...
            <span className="text-sm font-medium">Payroll & Compliance Tools</span>
