...
export default function HeroSection() {
  ...
  "
    ...
    w-16 h-16 sm:w-24 sm:h-24 lg:w-32 lg:h-32 2xl:w-44 2xl:h-44 
      ...
      >
        {/* Heading */}
        <h1
          className="text-[2rem]  min-[360px]:text-[34px] min-[375px]:text-[37px] min-[390px]:text-[37px] min-[414px]:text-[37px] min-[430px]:text-[px] sm:text-5xl md:text-6xl lg:text-[5rem] 2xl:text-[6.8rem]
  ...
  "
        ...
        <div
          ...
          pt-6 sm:pt-8 lg:pt-2 2xl:pt-12">
          <Button
            size="lg"
