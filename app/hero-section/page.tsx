...
export default function HeroSection() {
  ...
  {/* First line kept on one row from sm+ */}
  <span className="inline-flex items-baseline gap-2 sm:whitespace-nowrap">
    <span className="whitespace-nowrap">Simplifying</span>
    ...
    {/* NBSP before Law to keep them glued together */}
    <span className="relative inline-block whitespace-nowrap">
      <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 via-orange-600 to-red-500">
        &nbsp;Law
      </span>
  ...
  {/* Mobile-only break between Labour & Law (optional).
      Remove if you don’t want a break on very small screens. */}
  {/* <br className="block sm:hidden" /> */}

  <br />
  <span className="block text-slate-800 mt-1 2xl:mt-5 2xl:text-[6.2rem]">
    Compliance
  </span>

  <p
    className="
      text-[25px] sm:text-2xl md:text-3xl lg:text-4xl 2xl:text-6xl
      font-medium italic text-blue-600 mt-1 sm:mt-4 2xl:mb-10
    "
  >
    for Your Business
