      ...
      <main className="py-16">
        <div className="container mx-auto px-4">
          <Card className="max-w-4xl mx-auto shadow-lg">
            <CardHeader>
              <CardTitle className="text-3xl font-bold text-slate-800">Terms and Conditions</CardTitle>
            </CardHeader>
            <CardContent className="prose prose-slate max-w-none text-gray-700 leading-relaxed">
              <p>
                This page is currently under construction. Please check back later for our full Terms and Conditions.
              </p>
              <p>
