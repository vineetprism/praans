    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-r from-orange-500 to-orange-600 text-white py-8">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex items-center justify-between">
            <h1 className="text-3xl font-bold">NFH Details</h1>
            <select className="bg-white text-gray-900 px-4 py-2 rounded border">
              <option value={slug}>{data.name}</option>
            </select>
          </div>
        </div>
      </div>
              ...
              <table className="w-full">
                <tbody>
                    ...
                    <td className="p-4">
                      <div className="grid grid-cols-3 gap-4">
                        <div>
                          ...
                          <div className="text-gray-700">{data.applicability.factory}</div>
                        </div>
                        <div>
                          <div className="font-medium text-gray-900">Shops</div>
                          <div className="text-gray-700">{data.applicability.shops}</div>
                        </div>
                        <div>
                          <div className="font-medium text-gray-900">Plantation</div>
                          <div className="text-gray-700">{data.applicability.plantation}</div>
                        </div>
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr className="border-b border-gray-200">
                    ...
                    <td className="p-4">
                      <div className="flex items-start gap-4">
                        <span className="font-semibold text-gray-900">{data.nationalHolidays.count}</span>
                  ...
                  <tr className="border-b border-gray-200">
                    ...
                    <td className="p-4">
                      <div className="flex items-start gap-4">
                        <span className="font-semibold text-gray-900">{data.festivalHolidays.count}</span>
                  ...
                  <tr className="border-b border-gray-200">
                    ...
                    <td className="p-4 text-gray-700 font-semibold">{data.totalHolidays}</td>
                  </tr>
