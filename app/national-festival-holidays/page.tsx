    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-r from-orange-500 to-orange-600 text-white py-12">
        <div className="container mx-auto px-4 max-w-6xl">
          <h1 className="text-4xl font-bold mb-4">National and Festival Holidays Matrix</h1>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <Card className="border-2 border-gray-200">
            <CardHeader className="bg-gray-50">
              <CardTitle className="text-xl text-gray-900">Applicable States</CardTitle>
            </CardHeader>
              ...
              <div className="space-y-2">
                {applicableStates.map((state, index) => (
                  <Link
                    ...
                    className="block text-orange-600 hover:text-orange-800 hover:underline transition-colors duration-200"
                  >
                    {index + 1}. {state.name}
                  </Link>
                ))}
          ...
          <Card className="border-2 border-gray-200">
            <CardHeader className="bg-gray-50">
              <CardTitle className="text-xl text-gray-900">Non-Applicable States</CardTitle>
            </CardHeader>
            <CardContent className="p-6">
              <div className="space-y-2">
                {nonApplicableStates.map((state, index) => (
                  <Link
                    key={state.slug}
                    href={`/national-festival-holidays/${state.slug}`}
                    className="block text-gray-600 hover:text-gray-800 hover:underline transition-colors duration-200"
                  >
                    {index + 1}. {state.name}
                  </Link>
                ))}
