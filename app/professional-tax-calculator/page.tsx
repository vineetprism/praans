      ...
      <div className="max-w-lg w-full">
        ...
        <div className="rounded-xl shadow-lg overflow-hidden border border-orange-200 bg-white">
          ...
          <div className="p-8 sm:p-12 text-center">
            ...
            <p className="text-sm text-neutral-500 mb-8">
              We're working hard to bring you an amazing tool to calculate professional tax across Indian states with ease.
            </p>
            ...
            <div className="bg-orange-50 rounded-lg p-6 mb-8 text-left">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-neutral-700">Multi-state PT calculation with latest schedules</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-orange-600 font-bold mt-0.5">✓</span>
                  <span className="text-neutral-700">Support for exemptions and special categories</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-orange-600 font-bold mt-0.5">✓</span>
                  <span className="text-neutral-700">Annual and monthly projection reports</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-orange-600 font-bold mt-0.5">✓</span>
                  <span className="text-neutral-700">Downloadable calculation summaries</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="mt-8 text-center">
          <div className="inline-flex items-center gap-2 text-neutral-600">
            ...
            <span className="text-sm font-medium">Professional Tax Solutions</span>
