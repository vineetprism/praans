...
/* Tighter bullets + brand color (bullets are decorative; fine to keep) */
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-4 md:mb-6 lg:mb-8 gap-4">
            ...
            <div className="w-full md:w-auto md:flex md:flex-col md:items-end md:gap-2 lg:gap-3">
              <form
                ...
                aria-label="Search updates for news"
              >
                <input
                  type="text"
                  name="q"
                  ...
                  className="w-full px-3 py-2 md:py-1.5 border rounded-lg
                   ...
                   focus:outline-none focus:ring-2 focus:ring-orange-700 focus:border-orange-700"
                  aria-label="Search query for news"
                />
                <Button
                  type="submit"
                ...
                >
                  Search
                  <ArrowRight className="ml-1 h-3 w-3 lg:h-4 lg:w-4" aria-hidden="true" />
                </Button>
              </form>
              ...
              <form
                ...
                method="POST"
                className="flex items-center gap-2 w-full md:w-64 lg:w-72"
                aria-label="Newsletter subscription for news"
              >
                <input
                  type="email"
                  name="email"
                ...
                <Button
                  ...
                  className="bg-orange-700 hover:bg-orange-800 text-white
                   ...
                   focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-900"
                  aria-label="Subscribe to newsletter for news"
                >
                  Subscribe
                </Button>
              </form>
          ...
          <div className="relative">
            ...
            >
              {newsUpdates.map((news, i) => (
                <SwiperSlide key={i}>
                  <Card className="border-l-4 bg-gradient-to-br from-orange-50 to-orange-100 border-l-orange-600 hover:shadow-lg hover:scale-[1.02] transition-all duration-300 h-[140px] sm:h-[130px] md:h-[120px] lg:h-[125px] xl:h-[130px] flex flex-col">
                    <CardHeader className="p-3 pb-1 flex-shrink-0">
                      <div className="flex items-start justify-between gap-2">
                        <CardTitle className="text-xs sm:text-sm md:text-xs lg:text-sm leading-tight line-clamp-2 flex-1">
                          {news.href ? (
                            <Link
                              ...
                              aria-label={`Open update: ${news.title}`}
                            >
                              {news.title}
                            </Link>
                          ) : (
                        ...
                        {news.isNew && (
                          <span className="bg-orange-700 text-white text-[10px] px-1.5 py-0.5 rounded-full font-semibold">
                            New
                          </span>
                        )}
                      </div>
                      ...
                      <div className="flex items-center justify-between gap-2">
                        ...
                        {news.href && (
                          <Button
                            size="sm"
                            variant="ghost"
                            className="text-[10px] sm:text-xs px-2 py-0.5 h-5 sm:h-6 hover:bg-orange-100 hover:text-orange-800
                                       focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-800"
                            aria-label={`Read update: ${news.title}`}
                            asChild
                          >
                            <Link href={news.href} aria-label={`Read update: ${news.title}`}>
                              Read
                              <ArrowRight className="ml-0.5 w-2.5 h-2.5" aria-hidden="true" />
                            </Link>
                          </Button>
                        )}
                      </div>
            ...
            <div className="flex items-center justify-center gap-3 mt-4 lg:mt-6">
              <Button
                ...
                aria-label="Previous slide for news"
              >
              ...
              <Button
                ...
                aria-label="Next slide for news"
              >
