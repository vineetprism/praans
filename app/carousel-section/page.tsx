...
//               <div
//                 key={index}
//                 className="w-full sm:w-1/2 md:w-1/3 lg:w-1/6 flex-shrink-0"
//               >

// <Card className="border-l-4 border-l-orange-500 hover:shadow-md transition-shadow duration-200 h-[170px] flex flex-col justify-between">
...
//       </Badge>
//       {news.isNew && (
//         <Badge className="bg-green-500 text-white hover:bg-green-600 text-[10px] px-2 py-0.5">
//           <Star className="w-2 h-2 mr-1" />
//           New
//         </Badge>
//       )}
//     </div>
//     <CardTitle className="text-xs leading-tight hover:text-orange-500 transition-colors duration-200 line-clamp-1">
//       {news.href ? (
//         <Link href={news.href} className="hover:text-orange-500">{news.title}</Link>
//       ) : (
//         news.title
//       )}
//     </CardTitle>
...
//         {news.href && (
//           <Button size="sm" variant="ghost" className="text-[10px] px-1 py-0 h-6" asChild>
//             <Link href={news.href}>
//               Read <ArrowRight className="ml-1 w-2 h-2" />
//             </Link>
//           </Button>
//         )}
//         {news.downloadUrl && (
