...
//     <div className="relative border border-gray-100 shadow-sm bg-white rounded-lg hover:shadow-md hover:border-orange-200/50 transition flex flex-col h-full w-full">
//       <div className={`h-1 rounded-xl 2xl:h-1 ${category.color}`} />
//       {/* Mobile padding bigger for tap comfort; md+ same as before */}
//       <div className="flex-1 flex flex-col p-3 sm:p-2 md:p-3 lg:p-3 xl:p-4 2xl:p-5">
//         <div className="flex items-center gap-2 sm:gap-2 md:gap-3 lg:gap-3 xl:gap-3 2xl:gap-4 mb-1 sm:mb-1 md:mb-1.5 lg:mb-2 xl:mb-2 2xl:mb-3">
//           {/* Mobile icon slightly bigger; md+ unchanged */}
//           <div className={`w-7 h-7 sm:w-6 sm:h-6 md:w-7 md:h-7 lg:w-5 lg:h-5 xl:w-7 xl:h-7 2xl:w-10 2xl:h-10 ${category.color} rounded-md flex items-center justify-center shadow-sm group-hover:scale-105 transition-transform`}>
//             <category.icon className="text-white w-4 h-4 lg:w-4 lg:h-4" />
//           </div>
//           {/* Mobile title bigger & more legible; md+ same */}
...
//           <h2 className="text-lg sm:text-lg md:text-xl lg:text-4xl xl:text-4xl 2xl:text-7xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">
//             Explore Our <span className="bg-clip-text bg-gradient-to-r from-orange-500 to-orange-400">Resource Library</span>
//           </h2>
//           <p className="mt-3 sm:mt-2 text-[12px] sm:text-xs md:text-sm 2xl:text-[1.2rem] text-gray-600 max-w-2xl sm:max-w-3xl lg:max-w-4xl 2xl:max-w-5xl mx-auto leading-snug 2xl:leading-relaxed">
//             Navigate through our comprehensive collection of compliance resources organized by category.
//           </p>
//         </div>

//         {/* Grid – remove max-height on mobile (allow natural scroll); keep md+ caps */}
//         <div
//           className="
//             grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-4
...
//             <div
//               key={index}
//               // Mobile: auto height + a gentle min-height for touch; md+ keep fixed heights
//               className="h-auto min-h-[92px] sm:h-[85px] md:h-[90px] lg:h-[100px] xl:h-[110px] 2xl:h-[140px] w-full"
//             >
//               <CategoryCard category={category} index={index} />
//             </div>
//           ))}
  ...
  return (
    <section className="bg-gradient-to-br from-gray-50 via-white to-blue-50 relative overflow-hidden min-h-screen">
      ...
      <div className="mx-auto w-full max-w-7xl 2xl:max-w-[120rem] px-3 sm:px-4 md:px-6 2xl:px-8 relative z-10 py-4 2xl:py-6">
        {/* Header – mobile margin reduced, text slightly bigger; md+ same */}
        <div className="text-center mb-6 sm:mb-5 md:mb-6 lg:mb-8 xl:mb-8 2xl:mb-30">
          <h2 className="text-2xl sm:text-lg md:text-4xl lg:text-4xl xl:text-4xl 2xl:text-7xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">
            Explore Our{" "}
