...
//     <div
//       className="
//         relative border border-gray-100 shadow-sm bg-white rounded-lg hover:shadow-md hover:border-orange-200/50 transition
//         flex flex-col h-full w-full
//       "
//     >
//       {/* accent */}
...
//           <div
//             className={`w-7 h-7 md:w-8 md:h-8 ${category.color} rounded-md flex items-center justify-center shadow-sm group-hover:scale-105 transition-transform flex-shrink-0`}
//           >
//             <category.icon className="text-white" size={14} />
//           </div>
//           <h3 className="text-xs md:text-sm lg:text-sm font-semibold text-slate-900 group-hover:text-orange-600 transition-colors line-clamp-1 leading-tight">
//             {category.title}
//           </h3>
//         </div>

//         {/* description */}
//         <p className="text-[11px] md:text-xs lg:text-xs text-gray-600 group-hover:text-gray-700 leading-snug line-clamp-2">
//           {category.description}
//         </p>
//       </div>
//     </div>
...
//       <div className="mx-auto w-full max-w-7xl 2xl:max-w-[120rem] px-3 sm:px-4 md:px-6 2xl:px-10 relative z-10 py-4">
//         {/* header (tight) */}
//         <div className="text-center mb-3 md:mb-4">
//           <h2 className="text-lg md:text-2xl lg:text-3xl 2xl:text-4xl font-bold bg-gradient-to-r from-slate-800 to-slate-600 bg-clip-text text-transparent">
//             Explore Our <span className="bg-clip-text bg-gradient-to-r from-orange-500 to-orange-400">Resource Library</span>
//           </h2>
//           <p className="mt-1 text-xs md:text-sm text-gray-600 max-w-3xl mx-auto leading-snug">
//             Navigate through our comprehensive collection of compliance resources organized by category.
//           </p>
//         </div>

//         {/* GRID: 4 columns from md+; cap height so ALL cards fit in one viewport */}
//         <div
//           className="
//             grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-4
//             gap-2 md:gap-3 lg:gap-3 2xl:gap-4
//             mx-auto
//             max-h-[calc(100vh-180px)] 2xl:max-h-[calc(100vh-200px)]
//             overflow-hidden
//           "
//         >
//           {categories.map((category, index) => (
...
//               key={index}
//               className="
//                 h-[120px] sm:h-[125px] md:h-[125px] lg:h-[130px] xl:h-[135px] 2xl:h-[140px]
//               "
//             >
...
//     <section className="bg-gradient-to-br from-gray-50 via-white to-blue-50 relative overflow-hidden min-h-screen">
//       <div className="absolute inset-0 bg-gradient-to-br from-orange-100/10 via-transparent to-blue-100/10" />
//       <div className="mx-auto w-full max-w-7xl 2xl:max-w-[140rem] px-3 sm:px-4 md:px-6 2xl:px-8 relative z-10 py-4 2xl:py-6">
//         {/* Header (tighter on 2xl) */}
//         <div className="text-center mb-3 md:mb-4 2xl:mb-40">
...
//         {/* Grid: 4 columns on md+; uses more vertical + horizontal space on 2xl */}
//         <div
//           className="
//             grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-4
//             gap-2 md:gap-3 2xl:gap-6
//             mx-auto
...
//               key={index}
//               className="
//                 h-[120px] md:h-[125px] lg:h-[130px] xl:h-[135px] 2xl:h-[170px]
//               "
//             >
//               <CategoryCard category={category} index={index} />
//             </div>
