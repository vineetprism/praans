...
export default function InterestPenaltyCalculatorComingSoonPage() {
  return (
      ...
      <div className="max-w-lg w-full">
        ...
        <div className="rounded-xl shadow-lg overflow-hidden border border-orange-200 bg-white">
          ...
          <div className="p-8 sm:p-12 text-center">
            ...
            <p className="text-sm text-neutral-500 mb-8">
              We're building a powerful tool to calculate interest and penalties with multiple compounding methods, flexible penalty modes, and statutory compliance built-in.
            </p>
            ...
            <div className="bg-orange-50 rounded-lg p-6 mb-8 text-left">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-neutral-700">Simple, daily, and monthly compounding methods</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-orange-600 font-bold mt-0.5">✓</span>
                  <span className="text-neutral-700">Multiple day count conventions (ACT/365, ACT/366, 30/360)</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-orange-600 font-bold mt-0.5">✓</span>
                  <span className="text-neutral-700">Flexible penalty modes: flat, per-day, percentage-based</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-orange-600 font-bold mt-0.5">✓</span>
                  <span className="text-neutral-700">Grace period and weekend exclusion support</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-orange-600 font-bold mt-0.5">✓</span>
                  <span className="text-neutral-700">Penalty caps with min/max constraints</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-orange-600 font-bold mt-0.5">✓</span>
                  <span className="text-neutral-700">Pre-configured presets for PT, PF, and ESI scenarios</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="mt-8 text-center">
          <div className="inline-flex items-center gap-2 text-neutral-600">
            ...
            <span className="text-sm font-medium">Compliance & Payroll Tools</span>
