  ...
  return (
    <div className="p-6 overflow-x-auto flex flex-col lg:flex-row">
      ...
      <div className="lg:w-3/4 overflow-x-auto">
        <table className="w-full border border-black border-collapse text-sm table-auto">
          <thead>
            ...
            <tr>
              {headers.map((h, i) => (
                <th
                  key={i}
                  className={`border border-orange-100 bg-orange-50 font-bold text-center px-3 py-2 ${i === 0 ? "text-left" : ""}`}
