...
//       // Only scroll if user is near bottom or if it's a new message
...
//               {/* Chat Header */}
//               <div className="px-6 py-4 border-b border-orange-100 bg-gradient-to-r from-orange-50 to-orange-100/50 flex-shrink-0">
//                 <div className="flex items-center gap-3">
//                   <div className="w-8 h-8 bg-orange-500 rounded-full flex items-center justify-center">
//                     <span className="text-white text-sm">🤖</span>
//                   </div>
...
//               {/* Messages Area - Fixed height and scroll */}
//               <div 
...
//               <div className="border-t border-orange-100 p-4 bg-gray-50/50 flex-shrink-0">
//                 <div className="flex gap-3">
//                   <input
//                     value={input}
//                     onChange={(e) => setInput(e.target.value)}
