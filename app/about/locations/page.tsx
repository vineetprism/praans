...
export const metadata: Metadata = {
  ...
  description: 'Our locations in India with offices in Haryana, Karnataka, and Assam.',
  keywords: 'locations, praans consultech, india, offices, haryana, karnataka, assam',
}
