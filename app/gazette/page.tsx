...
//                 {/* Search */}
//                 <div>
//                   <label className="text-sm font-medium mb-2 block">Search Notifications</label>
...
//                           <Badge 
//                             variant={notification.state === 'Central' ? 'default' : 'secondary'}
//                             className={notification.state === 'Central' ? 'bg-slate-800' : 'bg-gray-100 text-gray-700'}
//                           >
...
//                         </div>
//                         <div className="text-sm text-gray-500 mb-2">
//                           <strong>Notification No:</strong> {notification.notificationNumber}
//                         </div> */}
//                       </div>
//                     </div>
...
//                         <span>{notification.format} • {notification.fileSize}</span>
//                       </div>
//                       <div className="flex items-center gap-1">
//                         <Calendar className="w-4 h-4" />
//                         <span>Published: {new Date(notification.publishedDate).toLocaleDateString()}</span>
//                       </div>
//                       <div className="flex items-center gap-1">
...
//                         <span>{formatViews(notification.views)} views</span>
//                       </div>
//                     </div> */}
//                   </CardHeader>
