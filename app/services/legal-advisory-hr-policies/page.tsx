...
//     title: "Labour Law Legal Advisory & HR Policies | Praans Consultech",
//     description:
//         "Stay compliant and prepared with our expert labour law legal advisory and hr policies services. We offer pre-audit reviews, on-site support, and technology-enabled compliance.",
//     keywords:
//         "labour law legal advisory, compliance hr policies, statutory audit services, labour law inspection support, compliance audit india",
// }
...
//                     <h1 className="text-4xl md:text-5xl font-bold mb-4 text-slate-800">Labour Law Legal Advisory & HR Policies</h1>
...
//                 <div className="container mx-auto px-4">
//                     <div className="text-center mb-16">
//                         <h2 className="text-4xl font-bold mb-4">Our Comprehensive Legal Advisory & HR Policies Services</h2>
//                     </div>
...
//                         <div>
//                             <h2 className="text-4xl font-bold mb-6">🔧 Technology-Enabled Legal Advisory & HR Policies</h2>
//                             <p className="text-lg text-gray-300 mb-6">
//                                 To enhance accuracy and efficiency, we integrate our AI-powered compliance management software with our
//                                 legal advisory and hr policies services.
//                             </p>
...
//                 <div className="container mx-auto px-4 text-center">
//                     <h2 className="text-4xl font-bold mb-4">Stay Ahead of Every Legal Advisory & HR Policies</h2>
//                     <p className="text-xl mb-8 max-w-3xl mx-auto">
//                         Being legal advisory and hr policies-ready is not optional—it's essential. With Praans Consultech, you gain the assurance of
//                         compliance and the confidence to face legal advisory and hr policies.
//                     </p>
//                     <Link href="/contact">
//                         <Button
//                             size="lg"
                    ...
                    <div className="mx-auto max-w-4xl">
                        <div className="bg-[#2a3154] text-white rounded-lg p-10 shadow-lg text-center">
                            ...
                            <div className="flex justify-center gap-6 flex-wrap">
                                ...
                                <Link
                                    href="mailto:sales@radixxcorp.com"
