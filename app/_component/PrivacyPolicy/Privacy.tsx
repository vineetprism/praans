                ...
                <main className="py-16">
                    <div className="container mx-auto px-4 max-w-4xl">
                        ...
                        <div className="prose prose-slate max-w-none text-gray-700 leading-relaxed space-y-6">
                            ...
                            <h2 className="font-bold">10. CCPA Privacy Policy (Do Not Sell My Personal Information)</h2>
                            <p>
                            ...
                            <h2 className="font-bold">11. GDPR Privacy Policy (Data Protection Rights)</h2>
                            <p>
                            ...
                            <h2 className="font-bold">12. Children’s Information</h2>
                            <p>
