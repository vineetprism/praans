...
//     // app/minimum-wages/[state]/StateMinimumWagesView.tsx
// "use client";
...
//   return /skilled/i.test(h) ? "text-green-600 font-semibold" : "text-gray-900";
// }
...
//                         <span className={classForHeader(h)}>{row[h] ?? "-"}</span>
//                       </div>
//                     ))}
//                   </div>
//                 </div>
...
//                 <tr>
//                   {headers.map((h) => (
//                     <th key={h} className="px-3 lg:px-4 py-2 lg:py-2.5 text-left text-xs lg:text-sm font-semibold text-white uppercase tracking-wide">
//                       {h}
//                     </th>
//                   ))}
//                 </tr>
...
//                       <td
//                         key={h}
//                         className={`px-3 lg:px-4 py-2 lg:py-3 text-xs lg:text-sm ${
//                           /skilled/i.test(h) ? "text-green-600 font-semibold" : "text-gray-900"
//                         }`}
//                       >
//                         {row[h] ?? "-"}
//                       </td>
...
//                 {rows.length === 0 && (
//                   <tr>
//                     <td colSpan={headers.length || 1} className="px-4 py-6 text-center text-sm text-gray-500">
//                       No data available.
//                     </td>
//                   </tr>
//                 )}
...
// // ---------- View (client) ----------
// export default function StateMinimumWagesView({ data }: { data: DetailData }) {
//   const mw = data.minimum_wage_rates;
//   const cat = data.employment_categories_benefits;
//   const tiles = data.tiles ?? {};

//   const quickTiles = [
//     { icon: Download, title: tiles.form_title ?? "Download Notifications", sub: "Get wage-related forms and returns", href: tiles.form_url },
//     { icon: IndianRupee, title: tiles.calculator_title ?? "Wage Calculator", sub: "Calculate wages and overtime", href: tiles.calculator_url },
//     { icon: Globe, title: "Official Website", sub: "Visit state labour department", href: tiles.website_url },
//   ].filter((t) => !!t.href);
...
//               <div>
//                 <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-2xl xl:text-3xl font-bold text-gray-900">Minimum Wages :</h1>
...
//             {/* Table 1 */}
//             <DynamicTable title={mw?.title ?? "Minimum Wage Rates (Daily in ₹)"} headers={mw?.headers ?? []} rows={mw?.rows ?? []} />

//             {/* Table 2 */}
//             <DynamicTable title="Employment Categories & Additional Benefits" headers={cat?.headers ?? []} rows={cat?.rows ?? []} />
...
//                           <h3 className="text-sm lg:text-base font-semibold text-gray-900 mb-1">{t.title}</h3>
...
//   updated_date: string;   // e.g. "19-09-2025"
//   effective_date: string; // e.g. "20-09-2025"
...
// export default function MinimumWageDetails({ data }: { data: DetailData }) {
//   const mw = data.minimum_wage_rates;
//   const cat = data.employment_categories_benefits;
//   const tiles = data.tiles ?? {};
...
//                           <th
//                             key={h}
//                             className="px-3 py-3 text-sm font-bold text-white uppercase tracking-wide"
//                           >
//                             {h}
//                           </th>
//                         ))}
...
//                               index === Math.floor(mw.headers.length / 2) ? 'bg-orange-600' : ''
//                             }`}
//                           >
//                             {h}
//                           </th>
...
//                                 isSkilledCol(h) ? "text-green-600 font-semibold" : ""
//                               } ${
//                                 index === Math.floor(mw.headers.length / 2) ? 'bg-orange-100' : ''
//                               }`}
//                             >
//                               {fmt(cell(r, h))}
//                             </td>
...
//                             key={h}
//                             className={`px-3 py-3 text-sm font-bold text-white uppercase tracking-wide text-center ${
//                               index === Math.floor(cat.headers.length / 2) ? 'bg-orange-600' : ''
//                             }`}
//                           >
//                             {h}
//                           </th>
...
//                                 isSkilledCol(h) ? "text-green-600 font-semibold" : ""
//                               } ${
//                                 index === Math.floor(cat.headers.length / 2) ? 'bg-orange-100' : ''
//                               }`}
//                             >
//                               {fmt(cell(r, h))}
//                             </td>
...
//                                 isSkilledCol(h) ? "text-green-600 font-semibold" : ""
//                               } ${
//                                 index === Math.floor(mw.headers.length / 2) ? 'bg-orange-100 border-l-4 border-r-4 border-orange-500' : ''
//                               }`}
//                             >
//                               {fmt(cell(r, h))}
//                             </td>
...
//                                 isSkilledCol(h) ? "text-green-600 font-semibold" : ""
//                               } ${
//                                 index === Math.floor(cat.headers.length / 2) ? 'bg-orange-100 border-l-4 border-r-4 border-orange-500' : ''
//                               }`}
//                             >
//                               {fmt(cell(r, h))}
//                             </td>
...
//                             key={h}
//                             className={`px-3 py-3 text-sm font-bold text-white uppercase tracking-wide text-center ${
//                               index > 0 ? 'border-l-4 border-orange-700' : ''
//                             }`}
//                           >
//                             {h}
//                           </th>
...
//                           key={h} 
//                           className={`flex gap-2 justify-between p-2 rounded ${
//                             index > 0 ? 'border-l-4 border-orange-500 pl-3' : ''
//                           }`}
//                         >
//                           <span className="font-medium text-gray-600">{h}:</span>
//                           <span className={`${isSkilledCol(h) ? "text-green-600 font-semibold" : ""}`}>
