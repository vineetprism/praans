...
// import MinimumWage from "@/app/_component/MinimumWages/MinimumWages";
// // import type { MinimumWageItem } from "./page";
// import PopularSearch from "@/app/PopularSearch/PopularSearch";

// type Props = { items: MinimumWage[] };
...
//                 className="bg-orange-300 rounded-lg border border-gray-200 p-4 shadow-sm"
//               >
...
//                     >
//                       <Link href={`/minimum-wages/${w.state_slug}`}>
//                         View
//                       </Link>
//                     </Button>
//                   </div>
...
import { Search } from "lucide-react";
// ❌ (Unused/confusing import hataya)
// import MinimumWage from "@/app/_component/MinimumWages/MinimumWages";
import PopularSearch from "@/app/PopularSearch/PopularSearch";
      ...
      <div className="px-3 sm:px-4 md:px-6 lg:px-8 xl:px-10 2xl:px-12">
        ...
        <div className="grid gap-4 sm:gap-5 md:gap-6 lg:grid-cols-4 xl:gap-8 w-full">
          ...
          <div className="lg:col-span-3 2xl:col-span-3 w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 items-stretch sm:items-center mb-6 sm:mb-8 md:mb-10 w-full">
              {/* Search Input */}
              <div className="relative flex-1">
                <Search className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 text-gray-400 w-4 h-4 sm:w-5 sm:h-5" />
                <Input
                  placeholder="Search by state..."
                  className="pl-10 sm:pl-12 h-8 sm:h-9 md:h-10 rounded-lg text-xs sm:text-sm w-full"
                  value={query}
                  onChange={(e) => setQuery(e.target.value)}
                />
              </div>
