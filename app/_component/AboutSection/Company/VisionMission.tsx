            ...
            <section className="relative overflow-hidden py-12 bg-gray-50">
                ...
                <div className="w-full px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="text-center mb-6">
                        ...
                        <p className="mt-2 text-[15px] text-[#1C284F] text-center max-w-3xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        <Card className="relative overflow-hidden rounded-2xl shadow-sm border border-gray-200">
                            <div className="absolute top-0 left-0 w-full h-2 bg-[#2c3454] rounded-t-2xl" />
                            <CardContent className="p-4">
                                <div className="mx-auto mb-2 flex h-10 w-10 items-center justify-center rounded-full bg-[#bec8dd]">
                                    <Shield className="h-6 w-6 text-[#2c3454]" />
                                </div>

                                <h3 className="text-center text-[20px] font-extrabold tracking-wide text-[#2c3454]">
                                    OUR MISSION
                                </h3>

                                <p className="mt-2 text-center text-[15px] text-gray-600 max-w-xl mx-auto text-justify">
                        ...
                        <Card className="relative overflow-hidden rounded-2xl shadow-sm border border-gray-200">
                            ...
                            <CardContent className="p-4">
                                ...
                                <h3 className="text-center text-[20px] font-extrabold tracking-wide text-orange-500">
                                    OUR VISION
                                </h3>
