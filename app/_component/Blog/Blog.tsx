...
// // app/_component/Blog/Blog.tsx (Client Component)
// "use client";
// import * as React from "react";
// import Link from "next/link";
// import Image from "next/image";
...
//     router.push(`/blog-main?page=${page}`);
//   };
...
//                 isActive
//                   ? "bg-orange-500 border-orange-500 text-white shadow-md scale-105 hover:cursor-pointer"
//                   : "border-gray-300 text-gray-700 hover:bg-orange-50 hover:border-orange-500 hover:text-orange-600 hover:cursor-pointer"
//               }`}
...
//         disabled={currentPage === totalPages}
//         className={`flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 rounded-lg border transition-all hover:cursor-pointer ${
//           currentPage === totalPages
//             ? "border-gray-200 text-gray-400  cursor-not-allowed"
//             : "border-gray-300 text-gray-700 hover:bg-orange-50 hover:border-orange-500 hover:text-orange-600 hover:cursor-pointer"
//         }`}
...
//       >
//         <ChevronsRight size={16} className="sm:w-5 sm:h-5 hover:cursor-pointer" />
//       </button>
//     </nav>
//   );
// }
...
//           <span>
//             Showing page <strong className="text-orange-600 hover:cursor-pointer">{currentPage}</strong> of{" "}
