...
export default function BlogDetails({ post }: { post: ApiPost }) {
  ...
  const safeHtml = DOMPurify.sanitize(post.content || "", {
    ...
    ALLOWED_ATTR: [
      "href","target","class","id","type","start","reversed","style",
      "colspan","rowspan","border","cellpadding","cellspacing","width","height","align","valign","scope",
      "src","alt","title","loading","frameborder","allow","allowfullscreen","referrerpolicy"
    ],
    KEEP_CONTENT: true,
  });
