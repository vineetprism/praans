...
//                                   <div key={`${yearIndex}-${amendmentIndex}`} className="flex items-start gap-4 py-3 last:border-b-0">
...
//                                       {normalizeUrl(amendment?.doc_url, amendment?.doc_path || null) ? (
//                                         <Button
//                                           size="sm"
...
//                 {/* Amendments */}
//                 <TabsContent value="amendments" className="space-y-2 sm:space-y-3 lg:space-y-4">
//                   <Card className="shadow-sm border-gray-200">
//                     <CardHeader className="pb-2 sm:pb-3 lg:pb-4">
//                       <CardTitle className="flex items-center gap-1.5 sm:gap-2 text-sm sm:text-base lg:text-lg">
//                         <Scale className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 text-orange-500 flex-shrink-0" />
...
//                             <Scale className="w-6 h-6 sm:w-8 sm:h-8 text-gray-400" />
//                           </div>
//                           <p className="text-gray-500 text-xs sm:text-sm font-medium mb-1">No amendments available</p>
//                           <p className="text-gray-400 text-[10px] sm:text-xs">Amendments will be added when available</p>
//                         </div>
//                       )}
//                     </CardContent>
//                   </Card>
...
//                                   return (
//                                     <TableRow key={form.id} className="transition-colors border-gray-200">
