              ...
              <div className="mb-8">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h1 className="text-3xl font-bold text-slate-800 mb-2">Labour Welfare Fund :</h1>
                    <p className="text-gray-600 text-xs sm:text-sm md:text-base lg:text-[0.9rem] text-justify leading-relaxed">
                      Understand the Labour Welfare Fund and how it safeguards employees’ well-being. Learn about its
                      benefits, contributions, and the role it plays in providing financial security, better facilities,
                      and overall welfare for workers and their families.
                    </p>
                  </div>
                </div>
              </div>
