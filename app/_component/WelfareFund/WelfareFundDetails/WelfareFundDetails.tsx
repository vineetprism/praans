...
//                       {actRows.map((r, idx) => (
//                         <tr key={idx} className="hover:bg-orange-50 2xl:w-[50px] text-justify">
//                           {actH.map((h) => {
//                             const raw = cell(r, h);
...
//                             if (low === "frequency") {
//                               return (
//                                 <td key={h} className="px-3 py-4 text-sm text-justify">
...
//                           <th
//                             key={h}
//                             className="px-3 py-3 text-sm font-bold text-white uppercase  text-center"
//                           >
//                             {h}
//                           </th>
//                         ))}
...
//                         <tr key={idx} className="hover:bg-orange-50 text-justify">
//                           {contribH.map((h) => (
//                             <td
//                               key={h}
//                               className={`px-3 py-4 text-sm ${
//                                 ["Employee", "Employer", "Total"].includes(h) ? "text-green-600 font-semibold 2xl:w-3xl text-justify" : "2xl:w-3xl text-justify"
//                               }`}
//                             >
//                               {fmt(cell(r, h))}
//                             </td>
      ...
      <div className=" mx-auto px-2 py-2 sm:px-3 sm:py-3 md:px-4 md:py-4 lg:px-5 lg:py-4 xl:px-6 xl:py-5">
        ...
        <div className="grid gap-3 sm:gap-4 md:gap-5 lg:grid-cols-4 lg:gap-4 xl:gap-5">
          ...
          <div className="lg:col-span-3">
            ...
            {/* --------- Labour Welfare Fund Contribution Table --------- */}
            {/* Desktop */}
            <Card className="hidden md:block mb-3 shadow-sm border-l-4 border-l-orange-500">
              <CardHeader className="pb-1 lg:pb-2">
                <CardTitle className="text-base lg:text-lg font-bold">Labour Welfare Fund Contribution</CardTitle>
