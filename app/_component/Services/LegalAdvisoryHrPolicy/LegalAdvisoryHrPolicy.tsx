          ...
          <div className="grid gap-8 md:grid-cols-1 lg:grid-cols-2 items-center">
            <div>
              ...
              <p className="mt-4 text-[15px] text-slate-700 max-w-xl">
                Stay compliant, prepared and confident. Praans Consultech
                provides full-stack labour law advisory with technology-enabled
                audit readiness and field support to minimize legal and
                operational risk.
              </p>
          ...
          <div className="grid gap-8 md:grid-cols-2 items-stretch">
            ...
            >
              ...
              <div className="ml-4 flex-1">
                ...
                <p className="text-slate-700 mb-5">
                  A focused review of your statutory records, systems and
                  on-ground practices to confirm compliance with central and
                  state labour statutes — we surface gaps and provide pragmatic
                  remediation.
                </p>
                ...
                <dl className="space-y-3 text-slate-700">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <dd className="text-sm">
                        Verify statutory registers, returns and filing schedules
                        for completeness.
                      </dd>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <dd className="text-sm">
                        Cross-check payroll compliance, contributions, and
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <dd className="text-sm">
                        Ensure licenses are valid and leave records are
                        maintained per regulation.
                      </dd>
                    </div>
                  </div>
                </dl>
            ...
            >
              ...
              <div className="ml-4 flex-1">
                ...
                <p className="text-slate-700 mb-5">
                  Government officials perform inspections that can be
                  scheduled, surprise, or complaint-triggered. We prepare you to
                  present documents and evidence confidently on-site.
                </p>
                ...
                <dl className="space-y-3 text-slate-700">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <dd className="text-sm">
                        Ensure statutory registers are updated and mandatory
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <dd className="text-sm">
                        Field review of working conditions, welfare facilities,
                        and employee rights.
                      </dd>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <dd className="text-sm">
                        We prepare documentation packs and a response playbook
                        for officers’ queries.
                      </dd>
                    </div>
                  </div>
                </dl>
      ...
      <section className="py-14 bg-gray-50">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="mt-2 text-gray-600 max-w-2xl mx-auto">
              Protect your operations with a proactive compliance posture —
              faster remediation, fewer fines, and better regulator relations.
            </p>
          </div>
        ...
        <style jsx>{`
          ...
          .group:focus .w-14 {
            background-color: rgba(
              ...
              255,
              0.08
            ) !important; /* subtle contrast ring for the icon circle */
          }
        `}</style>
      </section>
      ...
      <section className="py-14 bg-white">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-10">
            <h2 className="text-3xl font-bold">
              Our Comprehensive Legal Advisory & HR Policies Services
            </h2>
            <p className="mt-3 text-gray-600">
              Practical, auditable processes backed by field teams and software
        ...
        <div className="container mx-auto px-6 lg:px-8 grid gap-8 md:grid-cols-2 items-center">
          <div>
            ...
            <p className="text-gray-200 mb-6">
              We pair legal expertise with a secure compliance dashboard to
              track real-time status, keep digital registers, and generate
          ...
          <div className="mx-auto max-w-4xl">
            <div className="bg-[#2a3154] text-white rounded-lg p-10 shadow-lg text-center">
              ...
              <p className="max-w-3xl mx-auto text-gray-300 mb-8">
                Be inspection-ready 24/7. Combine legal advisory with our
                software to minimize risk and maintain continuity.
              </p>
