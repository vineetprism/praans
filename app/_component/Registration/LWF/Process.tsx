...
const STEPS: Step[] = [
    ...
    { title: "Labour Welfare Fund Registration", img: "/process/lwf.webp", alt: "Labour Welfare Fund Registration" },
];
...
const StepCard = ({ step }: { step: Step }) => {
    ...
    return (
        <div className="flex flex-col items-center text-center">
            ...
            <p className="text-[15px] font-semibold text-[#1c284f] max-w-[200px]">
                {title}
            </p>
        </div>
    );
            ...
            <section className="bg-[#16284b] text-white py-4 sm:py-6">
                <div className="mx-auto max-w-6xl px-5 sm:px-6 lg:px-8 text-center">
                    <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight">
                        Labour Welfare Registration Process
                    </h1>
                    <p className="mt-4 text-[15px] leading-7 text-white/90">
                        At Praans Consultech, we make the Labour Welfare Registration process simple, fast, and hassle-free.
                    </p>
                    <p className="text-[15px] leading-7 text-white/90">
                        Whether you’re starting a small business or managing a large enterprise, we’re here to help you get compliant with Labour welfare fund regulations.
                    </p>
                </div>
            </section>
