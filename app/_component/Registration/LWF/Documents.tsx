...
const KEY_POINTS_LEFT = [
  {
    ...
    body:
      "The contribution rates vary by state. Both employers and employees contribute to the fund, with the employer’s share generally being higher.",
  },
  {
    title: "Submission Deadlines:",
    body:
      "Contributions must be paid within the deadlines set by the respective state Labour Welfare Board. Late payments may attract penalties.",
  },
];
...
const KEY_POINTS_RIGHT = [
  {
    ...
    body:
      "Employers must maintain proper records of their contributions and provide these during audits or inspections.",
  },
  {
    title: "Consequences of Non-Compliance:",
    body:
      "Penalties or fines as per the state-specific laws. Legal action from the Labour Welfare authorities. Loss of respect and reputation in the market.",
  },
];
