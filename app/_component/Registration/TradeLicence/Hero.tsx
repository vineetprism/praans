...
const HARDCODED_TITLE = "Trade Licence Registration Consultant";
...
export default function TradeLicenceHero() {
  ...
  const waMsg = encodeURIComponent("Hi, I need expert advice on Trade Licence registration.");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setBanner({ type: "success", msg: data?.message ?? "Thanks! Your request has been submitted. Our team will reach out ASAP." });
        ...
        <div className="grid gap-4 lg:grid-cols-12 lg:items-start lg:gap-5">
          ...
          <div className="max-w-none lg:col-span-7 pl-3 sm:pl-6 md:pl-10 lg:pl-14 xl:pl-20 2xl:pl-24 break-words">
            <h1 className="w-full text-center text-2xl font-extrabold tracking-tight text-[#1c284f] sm:text-3xl whitespace-normal lg:whitespace-normal">
              India’s Trusted <span className="text-orange-500">Trade Licence Registration</span>
            ...
            <div className="mx-auto w-full max-w-[560px] rounded-xl bg-white p-5 shadow-xl ring-1 ring-slate-200/70 sm:p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="mt-2 w-full cursor-pointer rounded-md bg-orange-500 px-4 py-2.5 text-sm font-semibold text-white shadow hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 disabled:opacity-60"
                >
      ...
      <div className="w-full bg-orange-500">
        <div className="mx-auto max-w-7xl px-4 py-6 text-sm font-semibold text-white">
          <div className="flex flex-col items-center justify-between gap-3 sm:flex-row">
            <span>Support: <Link href="mailto:info@praansconsultech.com" className="hover:underline">info@praansconsultech.com</Link></span>
            <span>Talk to us: <Link href="tel:+919050576838" className="hover:underline">+91 9050576838</Link></span>
            <span>Website: <Link href="https://www.praansconsultech.com" target="_blank" rel="noreferrer" className="hover:underline">www.praansconsultech.com</Link></span>
          </div>
        </div>
      </div>
    </section>
