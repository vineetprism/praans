...
const STEPS: Step[] = [
    ...
    { title: "Trade Licence Certificate", img: "/process/trade.webp", alt: "Trade Licence Certificate" },
];
...
export default function TradeLicenceProcessPage() {
    return (
            ...
            <section className="bg-[#16284b] text-white py-4 sm:py-6">
                <div className="mx-auto max-w-6xl px-5 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="mt-4 text-[15px] leading-7 text-white/90">
                        At Praans Consultech, we make the Professional Tax Registration process simple, fast, and hassle-free.
                    </p>
                    <p className="text-[15px] leading-7 text-white/90">
                        Whether you’re starting a small food business or managing a large enterprise, we’re here to help you get compliant with food safety regulations.
                    </p>
                </div>
            </section>
