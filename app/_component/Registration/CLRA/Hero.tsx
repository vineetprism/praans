                ...
                <div className="grid gap-2 lg:grid-cols-2 lg:items-start">
                    ...
                    <div className="max-w-2xl">
                        <h1 className="text-2xl font-extrabold tracking-tight text-slate-900 sm:text-3xl">
                            India’s Trusted <span className="text-orange-500">CLRA Registration & Licence Consultant</span>
                        </h1>
                        <p className="mt-1 text-sm font-semibold text-slate-600">
                            (An ISO Certified Company)
                        </p>

                        <p className="mt-4 text-[15px] leading-7 text-slate-700 font-semibold">
                            Get Your CLRA Registration/Licence Done Quickly and Hassle-Free Starting from Just{" "}
                            <span className="font-bold text-slate-900">Rs.6999/-</span> Only
                        </p>
                        ...
                        <div className="mt-5 flex items-center gap-2 text-[15px] text-slate-800 font-semibold">
                        ...
                        {/* Buttons (kept same styling, just placed side-by-side) */}
                        <div className="mt-6 flex items-center gap-3">
                            <button
                                type="button"
                                className="inline-flex items-center gap-2 rounded-full bg-slate-900 px-5 py-3 text-sm font-semibold text-white shadow hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-orange-500 hover:cursor-pointer"
                            >
                            ...
                            <button
                                type="button"
                                className="inline-flex items-center rounded-full bg-slate-900 px-5 py-3 text-sm font-semibold text-white shadow hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-orange-500 hover:cursor-pointer"
                            >
