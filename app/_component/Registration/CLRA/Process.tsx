...
const STEPS: Step[] = [
    ...
    { title: "CLRA Registration/ Licence Certificate", img: "/process/clra.webp", alt: "CLRA Registration/ Licence Certificate" },
];
...
export default function CLRAProcessPage() {
    return (
            ...
            <section className="bg-[#16284b] text-white py-4 sm:py-6">
                <div className="mx-auto max-w-6xl px-5 sm:px-6 lg:px-8 text-center">
                    <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">
                        CLRA Registration/ Licence Process
                    </h1>
                    <p className="mt-4 text-[15px] leading-7 text-white/90">
                        At Praans Consultech, we make the CLRA Registration and Licence process simple, fast, and hassle-free.
                    </p>
