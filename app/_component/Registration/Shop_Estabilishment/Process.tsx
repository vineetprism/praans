...
const STEPS: Step[] = [
    ...
    { title: "Shop & Establishment Registration", img: "/process/shop.webp", alt: "Shop & Establishment Registration Certificate" },
];
...
export default function ShopEstabilishmentProcessPage() {
    return (
            ...
            <section className="bg-[#16284b] text-white py-4 sm:py-6">
                <div className="mx-auto max-w-6xl px-5 sm:px-6 lg:px-8 text-center">
                    <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">
                        Shop & Establishment Registration Process
                    </h1>
                    <p className="mt-4 text-[15px] leading-7 text-white/90">
                        At Praans Consultech, we make the Shop & Establishment Registration process simple, fast, and hassle-free.
                    </p>
                    <p className="text-[15px] leading-7 text-white/90">
                        Whether you’re starting a small business or managing a large enterprise, we’re here to help you get compliant with regulations.
                    </p>
                </div>
            </section>
