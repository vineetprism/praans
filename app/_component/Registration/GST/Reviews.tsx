...
const FEATURES: Feature[] = [
    {
        ...
        desc: "From documentation to GSTIN issuance.",
        img: "/register/support.webp",
    },
    {
        title: "Quick Turnaround",
        desc: "Get your GSTIN without unnecessary delays.",
        img: "/register/process.webp",
    },
    {
        title: "Affordable Pricing",
        desc: "Transparent and competitive pricing.",
        img: "/register/price.webp",
    },
    {
        title: "Expert Guidance",
        desc: "Resolve any GST-related queries with ease.",
        img: "/register/guarantee.webp",
    },
];
...
/* -------------------- Page -------------------- */
export default function GSTReviews() {
