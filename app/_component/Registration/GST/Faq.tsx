  ...
  const faqs = [
    {
      ...
      a: "No, only businesses meeting the turnover threshold or specific criteria must register.",
    },
    {
      q: "How long does it take to get a GSTIN?",
      a: "Generally, the processing time takes 15-20 working days after document verification.",
    },
    {
      q: "Is GST registration required for freelancers?",
      a: "Yes, GST registration is required if their annual turnover exceeds ₹20 lakh (₹10 lakh for special category states) or if they provide interstate services.",
    },
    {
      q: "Can I cancel my GST registration?",
      a: "Yes, businesses may cancel their GST registration if they cease operations or no longer satisfy the eligibility criteria for registration.",
    },
    {
      q: "Can I register for GST voluntarily?",
      a: "Yes, even if your turnover is below the threshold, voluntary registration is allowed to claim input tax credit and enhance business credibility.",
    },

    {
      q: "What is GSTIN?",
      a: "The GSTIN (Goods and Services Tax Identification Number) is a unique number issued to every entity registered under the GST system.",
    },
    {
      q: "Is there a fee for GST registration?",
      a: "No, GST registration is free on the official government portal.",
    },
    {
      q: "What may be the consequences of GST non-registration?",
      a: "Failure to register when required can result in penalties, including fines and interest on unpaid taxes.",
    },
    {
      q: "Can a GST registration be amended?",
      a: "Yes, any changes to business details, such as address or contact information, can be updated through the GST portal.",
    },
    {
      q: "What is ARN in GST registration?",
      a: "ARN (Application Reference Number) is a unique number issued upon submitting a GST application, used to track its status.",
    },
  ];
    ...
    <main className="bg-gray-50">
      ...
      <section className="w-full px-4 sm:px-8 lg:px-12 xl:px-16 py-12">
        ...
        <p className="mx-auto max-w-4xl text-center text-[15px] text-slate-800 mt-2">
          Ensure compliance with India’s GST regulations and streamline your
          business operations with ease. Reach out to us today for hassle-free
          GST registration and dedicate your efforts to driving business growth.
        </p>
