...
const ENQUIRY_ENDPOINT = new URL("/api/enquiry", API_BASE).toString(); // same endpoint
const HARDCODED_TITLE = "GST Registration Consultant";
...
export default function GSTHero() {
  ...
  const waMsg = encodeURIComponent("Hi, I need expert advice on GST registration.");
      ...
      <div className="mx-auto w-full px-4 py-2 sm:py-4 lg:py-6">
        <div className="grid gap-4 lg:grid-cols-12 lg:items-start lg:gap-5">
          ...
          <div className="max-w-none lg:col-span-7 pl-3 sm:pl-6 md:pl-10 lg:pl-14 xl:pl-20 2xl:pl-24 break-words">
            ...
            <p className="mt-1 text-center text-sm font-semibold text-slate-600">(An ISO Certified Company)</p>

            <p className="mt-4 w-full text-[15px] leading-7 font-semibold text-slate-700 whitespace-normal">
              Get Your GST Registration Done Quickly and Hassle-Free Starting from{" "}
              <PriceHighlight>Rs.999/-</PriceHighlight>
            </p>
