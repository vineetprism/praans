...
export default function MsmeHero() {
  ...
  const waMsg = encodeURIComponent(
    "Hi, I need expert advice on MSME registration."
  );
        ...
        <div className="grid gap-4 lg:grid-cols-12 lg:items-start lg:gap-5">
          ...
          <div className="max-w-none lg:col-span-7 pl-3 sm:pl-6 md:pl-10 lg:pl-14 xl:pl-20 2xl:pl-24 break-words">
            ...
            <p className="mt-4 w-full text-[15px] leading-7 font-semibold text-slate-700 whitespace-normal">
              Get Your MSME Registration Done Quickly and Hassle-Free Starting
              from <PriceHighlight>Rs.799/-</PriceHighlight>
            </p>
            ...
            <div className="mx-auto w-full max-w-[560px] rounded-xl bg-white p-5 shadow-xl ring-1 ring-slate-200/70 sm:px-6 sm:py-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="mt-2 w-full cursor-pointer rounded-md bg-orange-500 px-4 py-2.5 text-sm font-semibold 
                  text-white shadow hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 disabled:opacity-60"
                  aria-label="Submit"
                >
