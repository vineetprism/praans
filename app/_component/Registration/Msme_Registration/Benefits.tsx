...
const financialBenefits: Benefit[] = [
    { title: "Collateral-Free Loans", desc: "MSMEs can secure collateral-free loans under the Credit Guarantee Fund Scheme (CGTMSE), enabling easy access to funds without risking assets." },
    { title: "Subsidies on Interest Rates", desc: "MSMEs are eligible for subsidized interest rates on loans under schemes like the Prime Minister’s Employment Generation Programme (PMEGP) and Stand-Up India." },
    { title: "Priority Sector Lending", desc: "Banks classify MSMEs as part of priority sector lending, making credit availability easier and faster." },
];

const taxBenefits: Benefit[] = [
    { title: "Lower Income Tax Rates", desc: "MSMEs benefit from a 25% tax rate for companies with turnover up to ₹400 crores, while proprietorships and partnerships enjoy slab-based tax rates." },
    { title: "GST Exemptions", desc: "MSMEs with turnover below ₹40 lakhs (goods) or ₹20 lakhs (services) are exempt from GST registration. For North-Eastern states, these thresholds are ₹20 lakhs and ₹10 lakhs, respectively." },
    { title: "GST Composition Scheme", desc: "Eligible MSMEs can opt for the Composition Scheme to pay reduced GST rates (1% for traders/manufacturers and 5% for restaurants) and file quarterly returns." },
    { title: "Reimbursement for ISO Certifications", desc: "Registered MSMEs can claim reimbursements for expenses incurred during ISO certification, promoting global quality standards." },
];

const govtProcurement: Benefit[] = [
    { title: "Exclusive Tenders", desc: "MSMEs have exclusive access to certain government tenders, ensuring a level playing field against large corporations." },
    { title: "Public Procurement Policy", desc: "Under the Public Procurement Policy, 25% of all government procurements are reserved for MSMEs, with 3% exclusively for women-owned MSMEs." },
    { title: "E-Marketplace Access", desc: "Registered MSMEs can sell products directly to government agencies through platforms like the Government e-Marketplace (GeM)." },
];
...
function PlainSection({ children, bg }: { children: React.ReactNode; bg: "white" | "gray" }) {
    return (
