        ...
        <div className="grid gap-4 lg:grid-cols-12 lg:items-start lg:gap-5">
          ...
          <div className="max-w-none lg:col-span-7 pl-3 sm:pl-6 md:pl-10 lg:pl-14 xl:pl-20 2xl:pl-24">
            ...
            <p className="mt-4 w-full text-[15px] leading-7 text-slate-800 font-semibold whitespace-normal text-center sm:text-left">
              Get Your FSSAI Registration Done Quickly and Hassle-Free Starting
              from Just <PriceHighlight>Rs.1299/-</PriceHighlight>
            </p>
            ...
            <ul className="mt-6 space-y-2 text-[15px] leading-6 text-slate-800 font-semibold">
              ...
              <li className="flex w-full items-start gap-2">
                <span className="mt-2 h-2 w-2 shrink-0 rounded-full bg-orange-500" />
                Free Consultation to Select Correct Licence For Your Business:
          ...
          <div className="flex flex-col items-center justify-between gap-3 sm:flex-row">
            <span>
              ...
              <Link
                ...
                aria-label="Praans Consultech Email"
              >
            ...
            <span>
              Talk to us:{" "}
              <Link href="tel:+919050576838" className="hover:underline" aria-label="Praans Consultech Phone Number">
                +91 9050576838
              </Link>
            </span>
            <span>
              ...
              <Link
                ...
                rel="noreferrer"
                className="hover:underline"
                aria-label="Praans Consultech Website"
              >
