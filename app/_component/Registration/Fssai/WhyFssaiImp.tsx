...
function PlainSection({
    ...
    return (
        <section className={bg === "gray" ? "bg-white py-8 sm:py-10" : "bg-gray-50 py-8 sm:py-10"}>
...
const benefits = [
    {
        ...
        desc:
            "Obtaining FSSAI registration is mandatory for every food business operating in India.",
    },
    {
        title: "Consumer Confidence",
        desc:
            "An FSSAI license guarantees that your food products comply with health and safety regulations.",
    },
    {
        title: "Avoid Legal Penalties",
        desc:
            "Not obtaining FSSAI registration may result in legal complications, including substantial fines.",
    },
    {
        title: "Market Access",
        desc:
            "FSSAI certification is often a prerequisite for entering both local and international markets.",
    },
    {
        title: "Improved Brand Reputation",
        desc:
            "It demonstrates to your customers that you’re dedicated to offering safe and high-quality food.",
    },
    {
        title: "Business Growth",
        desc:
            "As your business grows or expands online / across states, the FSSAI license is essential to meet regulatory requirements.",
    },
    {
        title: "Food Safety & Quality Assurance",
        desc:
            "FSSAI ensures strict hygiene and safety protocols, helping prevent contamination and foodborne illnesses.",
    },
    {
        title: "Professional Image",
        desc:
            "Registration enhances your professional image, making it easier to partner with retailers and suppliers.",
    },
];
