...
export default function SEApplicabilityDetails({
  ...
  const formButtonLabel =
    formTitle !== "—"
      ...
      : "Download";
  const formButton2Label =
    formTitle2 !== "—"
      ? formTitle2
      : formUrl2Norm
      ? fileNameFromUrl(formUrl2Norm)
      : "Download";
          ...
          <div className="w-full lg:col-span-3 min-w-0">
            ...
            {data?.writeup_space && (
              <div className="text-sm mt-2 mb-4 p-3 font-medium text-gray-800 leading-relaxed">
                <SanitizedHtmlContent html={data.writeup_space} />
              </div>
            )}
                          ...
                          <tr key={ridx} className="bg-white">
                            ...
                            {ridx === 0 && (
                              <td
                                ...
                                className="px-2 sm:px-3 lg:px-4 py-2 sm:py-4 text-xs sm:text-sm text-gray-900 align-middle border border-orange-500"
                              >
                                <div className="break-words text-left max-w-[480px]">
                                  {data.doc_required ? (
                                    <SanitizedHtmlContent
                                      html={data.doc_required}
                                    />
                                  ) : (
                                    "-"
                                  )}
                      ...
                      <div className="mt-3 bg-orange-50 border border-orange-200 rounded-lg px-3 sm:px-4 py-2 sm:py-3">
                        <div className="flex flex-col space-y-1">
                          ...
                          <div className="text-xs sm:text-sm text-gray-800 leading-relaxed">
                            <SanitizedHtmlContent html={data.doc_required} />
                          </div>
                        </div>
                      </div>
                    )}
                ...
                <Card className="h-[120px] w-full text-center border-l-4 border-l-[#E85C0D] shadow-md hover:shadow-lg transition-shadow">
                  <CardContent className="h-full flex flex-col items-center justify-center px-2">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        openProtectedDownload(router, formUrl2Norm)
                      }
                    >
                      {formButton2Label}
                    </Button>
...
//   try {
//     const u = new URL(val);
//     if (LOCAL_HOSTS.has(u.hostname) && API_ORIGIN) {
//       return API_ORIGIN + u.pathname + u.search + u.hash;
//     }
//     return u.toString();
//   } catch {
...
//                               >
//                                 <div className="break-words text-left max-w-[320px]">
//                                   {data.doc_required ? (
//                                     <SanitizedHtmlContent html={data.doc_required} />
//                                   ) : (
//                                     "-"
