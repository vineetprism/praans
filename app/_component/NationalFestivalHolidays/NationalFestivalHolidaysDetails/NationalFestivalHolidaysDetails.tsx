        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 lg:gap-6 xl:gap-8">
          ...
          <div className="lg:col-span-3">
            <Card className="border-l-4 border-l-orange-500">
              <CardContent className="p-0 border border-orange-400">
                <div className="lg:hidden divide-y divide-orange-400">
                  {headers?.map((header) => (
                    <div key={header} className="p-4">
                      <div className="text-sm font-bold mb-2 text-orange-700">
                        {header}
                      </div>
                      <div className="space-y-2 border-orange-700">
                        {rows?.map((row, idx) => (
                          <div key={idx}>
                  ...
                  <table className="w-full text-left">
                    <tbody>
                      {headers?.map((header) => (
                        <tr
                          key={header}
                          className="border border-orange-400 align-top"
                        >
                          <td className="p-4 lg:p-5 font-bold bg-orange-100 text-orange-700 w-1/3 min-w-[260px] ">
                            {header}
                          </td>
