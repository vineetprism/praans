...
//   // ---- DECODE HTML ENTITIES (so '&lt;p&gt;' -> '<p>') ----
//   const decoded = (() => {
//     try {
//       // DOMParser parses text/html and decodes entities in textContent
...
export default function SanitizedHtmlContent({ 
  ...
  useEffect(() => {
    ...
    const decoded = (() => {
      try {
        // DOMParser parses text/html and decodes entities
        const doc = new DOMParser().parseFromString(html, "text/html");
        
        // ✅ FIX: Use innerHTML instead of textContent
        // innerHTML preserves HTML tags, textContent removes them
