...
//   // Scroll effect (Only for client-side rendering)
//   useEffect(() => {
//     const handleScroll = () => {
...
//                     {/* Active indicator */}
//                     {active && (
//                       <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-2 h-0.5 rounded-full" />
//                     )}
//                   </Link>
...
export default function SiteHeader() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`bg-gradient-to-r from-orange-500 to-orange-600 text-white transition-all duration-300 ease-in-out overflow-hidden ${
          hideTopBar ? "h-0 py-0 opacity-0" : "h-10 py-2 opacity-100"
        }`}
      >
        <div className="container mx-auto px-4">
          <div
            className={`flex items-center justify-center text-sm transition-transform duration-300 ${
              hideTopBar ? "transform -translate-y-full" : "transform translate-y-0"
            }`}
          >
            <div className="flex items-center gap-4">
      ...
      <div className="container mx-auto px-4 border-b border-gray-200">
        ...
        <div className="h-16 lg:h-20 flex items-center justify-between">
          ...
          <div className="max-lg:hidden flex items-center gap-2">
            ...
            <Button className="relative bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 rounded-xl font-semibold px-6 shadow-lg shadow-orange-500/25 hover:shadow-orange-500/40 transition-all duration-200 group">
              <span className="relative z-10">Get Started</span>
              <ArrowRight className="w-4 h-4 ml-2 transition-transform group-hover:translate-x-0.5" />
            </Button>
          </div>
          ...
          <div className="lg:hidden flex items-center gap-2">
            <Sheet>
              ...
              <SheetContent side="right" className="w-80 bg-gradient-to-b from-white to-orange-50/30">
                ...
                <div className="mt-8 space-y-3 pt-6 border-t border-orange-100">
                  <Button variant="ghost" size="lg" className="w-full justify-center rounded-xl hover:bg-orange-50 hover:text-orange-600 font-semibold">
                    <User className="w-4 h-4 mr-2" />
                    Sign In
                  </Button>
                  <Button size="lg" className="w-full justify-center bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 rounded-xl font-semibold shadow-lg">
                    Get Started
                    <ArrowRight className="w-4 h-4 ml-2" />
                  </Button>
                </div>
