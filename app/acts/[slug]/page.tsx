...
const actsDatabase = {
  "factories-act-1948": {
    ...
    fullTitle:
      "An Act to consolidate and amend the law regulating labour in factories",
    state: "Central",
    applicableState: "All India", // Added this field
    category: "Industrial Safety",
    year: "1948",
    actNumber: "Act No. 63 of 1948",
    lastUpdated: "2024-12-15",
  ...
  "contract-labour-act-1970": {
    ...
    penalties: "Imprisonment up to 1 year and/or fine up to ₹1,000 for violations.",
    amendments: [
      {
        year: "2021",
  ...
  "maharashtra-shops-establishments-act-2017": {
    ...
    fullTitle: "An Act to consolidate and amend the law relating to the regulation of conditions of work and employment in shops and establishments",
    state: "Maharashtra",
    ...
    objective: "To consolidate and amend the law relating to the regulation of conditions of work and employment in shops and establishments.",
    keyProvisions: [
              ...
              <CardHeader>
                <div className="space-y-4">
                  ...
                  <div className="flex items-start justify-between gap-1.5">
                    ...
                    {/* State Badge - Added this section */}
                    <Badge
                      variant="outline"
