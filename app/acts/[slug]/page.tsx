...
//   state: string;
//   short_description: string;
//   act_desc: string;  // sanitized HTML
//   rule_desc: string; // sanitized HTML
//   act_doc_path?: string | null;
//   act_doc_url?: string | null;
//   rule_doc_path?: string | null;
//   rule_doc_url?: string | null;
...
// type ActDetailAPI = { data: Omit<ActDetail, "act_desc" | "rule_desc"> & {
...
// };
// function clean(html: string | null | undefined) {
//   if (!html) return "";
...
//   // Server-side sanitize before passing to client
//   const cleanAct: ActDetail = {
//     ...act!,
//     act_desc: clean(act?.act_desc),
//     rule_desc: clean(act?.rule_desc),
//   };

//   return <ActDetailClient act={cleanAct} />;
// }
