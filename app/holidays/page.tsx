...
// export default function HolidaysPage() {
//   const [holidays, setHolidays] = useState<any[]>([]); // State to store fetched holidays
...
//                 <p className="text-gray-700 leading-relaxed text-xs sm:text-sm text-justify mb-3">
//                   "Statutory Holidays" is public or legal holidays designated by government or authorities based on
//                   cultural, religious, historical or national significance within a particular country or region as
//                   mandated by law. Every employee is entitled to a day-off with pay or premium pay if they work on such
//                   occasions.
//                 </p>
//               </div>
//             </div>
